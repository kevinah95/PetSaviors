...
public class VistaEditarTipo extends JPanel{
	...
	public VistaEditarTipo() {
		...
		btnPerfil.setIcon(new ImageIcon(VistaEditarTipo.class.getResource("/recursos/profileEncima3.png")));
		...
		panel.add(lblBG);
		lblBG.setIcon(new ImageIcon(VistaEditarTipo.class.getResource("/recursos/TipoUsuario.png")));
	}
}
